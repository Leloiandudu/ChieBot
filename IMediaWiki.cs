...
public interface IMediaWiki
{
    ...
    IDictionary<string, string[]> GetLinksTo(string[] titles, int? inNamespace = -1);
    IDictionary<int, string[]> GetNamespaces();
    ...
    string[] GetPagesInCategory(string categoryName, int pageNamespace = -1);
    string[] GetPageTransclusions(string page, int inNamespace = -1);
    IDictionary<string, string[]> GetPageTransclusions(string[] pages, int inNamespace = -1);
    ...
    IDictionary<string, string[]> GetTransclusionsOf(string[] titles, int? inNamespace = -1);
